...
quitbutton = widget_button(quitmenu,value="Quit",event_pro='adjust_quit')
...
;print,cinfo.adjust_roi.x1,cinfo.adjust_roi.x2,cinfo.adjust_roi.y1,cinfo.adjust_roi.y2
...
cinfo.coadd.doneID = widget_button(done_box, value ='Done', uvalue= 'done',font=cinfo.font5)
...
XManager,'adjust',cinfo.AdjustROI,/No_Block,event_handler = 'adjust_event'
