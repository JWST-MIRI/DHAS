...
pro cv_update_image2d,cinfo,ps=ps,eps = eps

if(cinfo.coadd.flag ne 3) then begin
...
;print,'in update image2d',cinfo.view_image2d.xpos, cinfo.view_image2d.ypos,xsize,ysize
...
image = (*cinfo.image2d.pimage)
uimage = (*cinfo.image2d.puimage)
isum  = (*cinfo.image2d.pisum)

sub_image = fltarr(xsubsize,ysubsize)   

sub_image[ixstart:ixend,iystart:iyend] =image[xstart:xend,ystart:yend]

if ptr_valid (cinfo.image2d.psubdata) then ptr_free,cinfo.image2d.psubdata
cinfo.image2d.psubdata = ptr_new(sub_image)



loadct,cinfo.col_table,/silent

get_image_stat,sub_image,sub_mean,sub_std,image_min,$
               image_max,range_min,range_max,$
               sub_median,std_mean,skew,n_pixels,numbad
...
w1 = (*cinfo.cube.pwavelength)[cinfo.image2d.z1]
w2 = (*cinfo.cube.pwavelength)[cinfo.image2d.z2]
...
cv_box_stat_image,xstart,xend,ystart,yend,cinfo.image2d,cinfo.cube,box_stat_image
