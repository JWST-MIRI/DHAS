    ...
    if printfil eq 0 then begin
	  ...
	  0: Begin  ; write postscript
	     ...
	     Widget_Control, printinfo.selectfile, Set_Value = filename
             ...
             cv_update_spectrum,printinfo.info,/ps
	     ...
	     Widget_Control, printinfo.selectfile, Set_Value = filename
             ...
             cv_update_spectrum,printinfo.info,/eps
...
;_______________________________________________________________________
pro cv_spec_print, info


if(XRegistered("cv_printspec")) then return
...
filename = info.control.dirps + slash + info.control.file_cube_base + $
  ...
  XManager, "cv_printspec", pntrbase, Event_Handler = "spec_print_event"
