...
;***********************************************************************
pro jwst_extract_spectrum_from_cube,x1,x2,y1,y2,jwst_cube,spectrum,status,w1=w1,w2=w2,nwave=nwave
;***********************************************************************
status = 0
input_filename = ' ' 
filename =jwst_cube.filename
...
if(keyword_set(w1)) then begin
    ...
    wavelength = (*jwst_cube.pwavelength)
...
if(iending_wavelength ne jwst_cube.naxis3 - 1) then full_cube = 0
; 
...
if(full_cube eq 1) then begin
    ...
    for i = 0,jwst_cube.naxis3 -1 do begin
        region = (*jwst_cube.pcubedata)[x1:x2,y1:y2,i]
        uregion = (*jwst_cube.puncertainty)[x1:x2,y1:y2,i]
