...
pro hist_print_data, event
  ...
  if fcount gt 0 then begin
    ...
    if printfil eq 0 then begin
        ...
        if(printhistinfo.type le 2)then  mql_update_histo,printhistinfo.hinfo,/ascii,unit=lun

        if(printhistinfo.type ge 3) then msql_update_histo,printhistinfo.hinfo,/ascii,unit=lun
