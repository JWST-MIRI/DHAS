...
pro inspect_images_print, event
...
iframe = info.inspect.FrameNO+1
jintegration = info.inspect.integrationNO+1
...
pntrbase   = Widget_Base  (Title = mtitle, /Column, $
                           Group_Leader=info.InspectImage, $
                           ;			      /Modal)
                           xsize = xwidget_size,$
...
selectfile = Widget_Text  (pntr1base, Value = filename, XSize = 100, /Edit, $
                           Event_Pro = 'inspect_images_print')
