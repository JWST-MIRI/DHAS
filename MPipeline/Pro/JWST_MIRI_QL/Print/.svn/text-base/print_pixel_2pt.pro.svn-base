...
;_______________________________________________________________________
pro print_pixel_2pt_event, event
...
i1 = info.pl2.int_range[0]
i2 = info.pl2.int_range[1]
...
if(info.pl2.group eq 0) then igroup = 'setA'
if(info.pl2.group eq 1) then igroup = 'setB'
if(info.pl2.group eq 2) then igroup = 'setC'
if(info.pl2.group eq 3) then igroup = 'setD'
...
outname = '_2pt_diff' + '_' + ij + '_' + igroup
if(info.pl2.overplot_slope eq 1) then outname = outname + '_slope'
mtitle = 'MIRI Quicklook Two-point Differences'
...
XManager, "mpl_print", pntrbase, Event_Handler = "print_pixel_2pt_event"
