    ...
    if printfil eq 0 then begin
	  ...
	  0: Begin  ; write postscript
	     ...
	     Widget_Control, printimageinfo.selectfile, Set_Value = filename
             ...
             mrp_update_TimeChannel,info,/ps
	     ...
	     Widget_Control, printimageinfo.selectfile, Set_Value = filename
             wset,info.refp.draw_window_id[2]
...
pro print_refpixel_event, event
...
;_______________________________________________________________________
pro print_reference_pixel_timeordered,info
...
iframe = info.refp.rampNO+1
jintegration = info.refp.integrationNO+1
...
outname = info.output.refpixel_time + '_' + ij
mtitle = 'MIRI Quicklook Print Reference Pixels in time order'
...
pntrbase   = Widget_Base  (Title = mtitle, /Column, $
                           Group_Leader=info.RefPixelQuicklook, $
                           xsize = xwidget_size,$
...
XManager, "mrp_printtime", pntrbase, Event_Handler = "print_refpixel_event"
