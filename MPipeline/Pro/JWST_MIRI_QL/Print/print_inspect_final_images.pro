...
pro inspect_final_images_print, event
...
;_______________________________________________________________________
pro print_inspect_final_images,info 
...
jintegration = info.inspect_final.integrationNO+1
...
pntrbase   = Widget_Base  (Title = mtitle, /Column, $
                           Group_Leader=info.InspectSlopeFinal, $
                           xsize = xwidget_size,$
...
selectfile = Widget_Text  (pntr1base, Value = filename, XSize = 100, /Edit, $
                           Event_Pro = 'inspect_final_images_print')
...
XManager, "misfql_printimage", pntrbase, Event_Handler = "print_event"
