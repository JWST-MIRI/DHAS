...
pro jwst_findhistogram,data_all,x_to_plot,hist_to_plot,numbins,bins,xplot_min,xplot_max,status
...
pro jwst_findhistogram_xlimits,data_all,x_to_plot,hist_to_plot,numbins,bins,xplot_min,xplot_max,xmin,xmax,status
;_______________________________________________________________________
;xnew center of each bin pt
; h is the number of pts corresponding to values that fall in
; the bin (with center  = x)
