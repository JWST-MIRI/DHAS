;***********************************************************************
pro jwst_mcql_stat_quit,event
widget_control,event.top, Get_UValue = tinfo
widget_control,tinfo.info.jwst_QuickLook,Get_UValue=info
widget_control,info.jwst_cal_StatInfo,/destroy
end
...
pro jwst_mcql_display_stat,info

window,4,/pixmap
wdelete,4
if(XRegistered ('mstat_cal')) then begin
    widget_control,info.jwst_cal_StatInfo,/destroy
endif
...
mean[1] = info.jwst_cal.zoom_stat[0]
st_pixel[1] = info.jwst_cal.zoom_stat[1]
var[1] = st_pixel[1]*st_pixel[1] 

min[1] = info.jwst_cal.zoom_stat[2] 
max[1] = info.jwst_cal.zoom_stat[3] 
median[1] = info.jwst_cal.zoom_stat[4] 
st_mean[1] = info.jwst_cal.zoom_stat[5] 

xstart = info.jwst_cal.x_zoom_start
xend = info.jwst_cal.x_zoom_end
ystart = info.jwst_cal.y_zoom_start
yend = info.jwst_cal.y_zoom_end

stitle[2] = " Statistics on Window 2"


stat = info.jwst_data.rate2_stat
plane = info.jwst_cal.plane[1]
mean[2] = stat[0,plane]
...
quitbutton = widget_button(quitmenu,value="Quit",event_pro='jwst_mcql_stat_quit')
...
info.jwst_cal_StatInfo = statinfo
stat = {info                  : info}	



Widget_Control,info.jwst_cal_StatInfo,Set_UValue=stat
widget_control,info.jwst_cal_StatInfo,/realize

XManager,'mstat_cal',info.jwst_cal_statinfo,/No_Block
