...
pro cinspect_images_print, event
    ...
    if printfil eq 0 then begin
	  ...
	  0: Begin  ; write postscript
	     ...
	     Widget_Control, printimageinfo.selectfile, Set_Value = filename
             ...
             micql_update_images,info,imageno,/ps
             device,/close
             set_plot, 'x'
           end
...
;_______________________________________________________________________
;_______________________________________________________________________
pro print_cinspect_images,info,imageno
...
iframe = info.cinspect[imageno].FrameNO+1
jintegration = info.cinspect[imageno].integrationNO+1
...
selectfile = Widget_Text  (pntr1base, Value = filename, XSize = 100, /Edit, $
                           Event_Pro = 'cinspect_images_print')
