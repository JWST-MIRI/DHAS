	  ...
	  0: Begin  ; write postscript
              ...
              for i = 0,2 do begin
                  ...
                  if(printhistinfo.type eq 1)then $
                    mql_update_compare_histo,graphno,printhistinfo.hinfo,/ps
	     ...
	     set_plot, 'ps', /copy
             ...
             for i = 0,2 do begin
                 ...
                 if(printhistinfo.type eq 2)then $
                   msql_update_compare_histo,graphno,printhistinfo.hinfo,/eps
...
; widget window parameters
  ...
  if(type eq 2) then grouplead =  info.HistoScompareQuickLook
  ...
  if fcount gt 0 then begin
    ...
    if printfil eq 0 then begin
        ...
        for i = 0,2 do begin
            ...
            if(printhistinfo.type eq 2)then $
              msql_update_compare_histo,graphno,printhistinfo.hinfo,/ascii,unit=lun
            close,lun
            free_lun,lun
        endfor
